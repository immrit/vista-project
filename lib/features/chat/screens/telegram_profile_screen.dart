// lib/features/chat/screens/telegram_profile_screen.dart
//
// صفحه پروفایل/جزئیات چت به سبک تلگرام
// طراحی دقیقاً مطابق با آخرین نسخه تلگرام
//
// ویژگی‌ها:
...
class TelegramProfileScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TelegramProfileScreen> createState() =>
      _TelegramProfileScreenState();
}

class _TelegramProfileScreenState extends ConsumerState<TelegramProfileScreen>
