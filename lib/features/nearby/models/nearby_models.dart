...
class NearbyPreferences {
  ...
  factory NearbyPreferences.fromJson(Map<String, dynamic> j) => NearbyPreferences(
...
class NearbyLikeResult {
  ...
  const NearbyLikeResult({required this.matched, required this.matchId, this.match});
