...
class _LoginuserState extends ConsumerState<Loginuser> {
    ...
    Future<void> signIn() async {
      ...
      try {
        ...
        if (isEmail(emailOrUsername)) {
          ...
          // Replace with actual server-side logic to retrieve email from username
          final email = await getEmailFromUsername(emailOrUsername);
          await account.createEmailPasswordSession(
            email: email,
            password: password,
          );
  ...
  Future<String> getEmailFromUsername(String username) async {
    // Implement logic to get email from username
    // This could be an API call that returns email based on username
    return 'user@example.com'; // Example email
  }
}
