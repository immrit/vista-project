...
class AppColors {
  ...
  static const Color glassBackgroundDark  = Color(0x990A0A0A); // 60% almost black
  static const Color glassBorderDark      = Color(0x33FFFFFF); // 20% white

  // ── Light Mode ──────────────────────────────────────────────────────────────
  static const Color lightBackground      = Color(0xFFF8F9FF); // کمی آبی-بنفش، نه خالص سفید
  ...
  // ── Dark Mode ───────────────────────────────────────────────────────────────
  static const Color darkBackground      = Color(0xFF09090F); // تقریباً سیاه با رنگ بنفش
  ...
  static const Color darkTextPrimary     = Color(0xFFF0F0FF); // کمی آبی‌تر از خالص سفید
    ...
    return ThemeData(
      ...
      textTheme: const TextTheme(
        ...
        bodyLarge: TextStyle(
          ...
          height: 1.6, color: AppColors.lightTextPrimary,
          fontFamily: _fontFamily,
        ),
        bodyMedium: TextStyle(
          fontSize: 14, fontWeight: FontWeight.normal,
          height: 1.5, color: AppColors.lightTextPrimary,
          fontFamily: _fontFamily,
        ),
        bodySmall: TextStyle(
      ...
      tabBarTheme: const TabBarThemeData(
        ...
        unselectedLabelStyle: TextStyle(
          fontFamily: _fontFamily, fontWeight: FontWeight.normal, fontSize: 15,
        ),
      ),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: const TextTheme(
        ...
        bodyLarge: TextStyle(
          fontSize: 16, fontWeight: FontWeight.normal,
          height: 1.6, color: AppColors.darkTextPrimary,
          fontFamily: _fontFamily,
        ),
        bodyMedium: TextStyle(
          fontSize: 14, fontWeight: FontWeight.normal,
          height: 1.5, color: AppColors.darkTextPrimary,
          fontFamily: _fontFamily,
        ),
        bodySmall: TextStyle(
          fontSize: 13, fontWeight: FontWeight.normal,
