...
import '../../widget/swipeable_conversation_item.dart';
// ✅ نشانگر وضعیت شبکه
      ...
      child: CustomScrollView(
        ...
        slivers: [
          ...
          if (pinnedConversations.isNotEmpty) ...[
            SliverToBoxAdapter(
              child: _buildSectionHeader(theme, 'پین شده', Icons.push_pin_rounded),
            ),
            SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  final conversation = pinnedConversations[index];
                  return _buildSwipeableItem(theme, conversation, index,
                      pinnedConversations.length, isPinnedSection: true);
                },
          ...
          if (regularConversations.isNotEmpty) ...[
            if (pinnedConversations.isNotEmpty)
              SliverToBoxAdapter(
                child: _buildSectionHeader(theme, 'همه گفتگوها', Icons.chat_rounded),
              ),
            SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  ...
                  return _buildSwipeableItem(theme, conversation, index,
                      regularConversations.length, isPinnedSection: false);
                },
        ...
        child: Column(
          ...
          children: [
            ...
            _buildOptionTile(
              ...
              title: conversation.isPinned ? 'حذف از سنجاق شده‌ها' : 'سنجاق کردن',
              onTap: () {
                Navigator.pop(context);
